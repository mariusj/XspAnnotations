...
@XmlType(name = "faces-config-lifecycleType", namespace = "http://java.sun.com/xml/ns/javaee", propOrder = {
    "phaseListener",
    "lifecycleExtension"
})
public class FacesConfigLifecycleType {
    ...
    public List<FullyQualifiedClassType> getPhaseListener() {
        if (phaseListener == null) {
            phaseListener = new ArrayList<FullyQualifiedClassType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FacesConfigLifecycleExtensionType }
     * 
     * 
     */
    public List<FacesConfigLifecycleExtensionType> getLifecycleExtension() {
        if (lifecycleExtension == null) {
            lifecycleExtension = new ArrayList<FacesConfigLifecycleExtensionType>();
        }

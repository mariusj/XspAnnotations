...
@XmlType(name = "faces-config-navigation-rule-extensionType", namespace = "http://java.sun.com/xml/ns/javaee", propOrder = {
    "any"
})
public class FacesConfigNavigationRuleExtensionType {

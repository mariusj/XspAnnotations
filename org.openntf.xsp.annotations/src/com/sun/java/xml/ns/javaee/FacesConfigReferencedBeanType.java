...
@XmlType(name = "faces-config-referenced-beanType", namespace = "http://java.sun.com/xml/ns/javaee", propOrder = {
    "description",
    "displayName",
    "icon",
    "referencedBeanName",
...
public class FacesConfigReferencedBeanType {
    ...
    protected JavaIdentifierType referencedBeanName;
    @XmlElement(name = "referenced-bean-class", required = true)
    protected FullyQualifiedClassType referencedBeanClass;
    @XmlAttribute

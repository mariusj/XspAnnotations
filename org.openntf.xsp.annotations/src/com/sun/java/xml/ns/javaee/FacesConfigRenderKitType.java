...
@XmlType(name = "faces-config-render-kitType", namespace = "http://java.sun.com/xml/ns/javaee", propOrder = {
    "description",
    "displayName",
    "icon",
    "renderKitId",
...
public class FacesConfigRenderKitType {
    ...
    protected com.sun.java.xml.ns.javaee.String renderKitId;
     ...
     *     
     */
    public com.sun.java.xml.ns.javaee.String getRenderKitId() {
        return renderKitId;
    }
     ...
     *     
     */
    public void setRenderKitId(com.sun.java.xml.ns.javaee.String value) {
     ...
     *     
     */
    public void setRenderKitClass(FullyQualifiedClassType value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FacesConfigRendererType }
     * 
     * 
     */
    public List<FacesConfigRendererType> getRenderer() {
        if (renderer == null) {
            renderer = new ArrayList<FacesConfigRendererType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FacesConfigRenderKitExtensionType }
     * 
     * 
     */
    public List<FacesConfigRenderKitExtensionType> getRenderKitExtension() {
        if (renderKitExtension == null) {
            renderKitExtension = new ArrayList<FacesConfigRenderKitExtensionType>();
        }

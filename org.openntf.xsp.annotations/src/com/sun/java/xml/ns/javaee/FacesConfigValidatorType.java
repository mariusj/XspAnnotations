...
@XmlType(name = "faces-config-validatorType", namespace = "http://java.sun.com/xml/ns/javaee", propOrder = {
    "description",
    "displayName",
    "icon",
    "validatorId",
...
public class FacesConfigValidatorType {
    ...
    protected com.sun.java.xml.ns.javaee.String validatorId;
     ...
     *     
     */
    public com.sun.java.xml.ns.javaee.String getValidatorId() {
        return validatorId;
    }
     ...
     *     
     */
    public void setValidatorId(com.sun.java.xml.ns.javaee.String value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FacesConfigValidatorExtensionType }
     * 
     * 
     */
    public List<FacesConfigValidatorExtensionType> getValidatorExtension() {
        if (validatorExtension == null) {
            validatorExtension = new ArrayList<FacesConfigValidatorExtensionType>();
        }
